...
export const defaultRegisterWidthToSubRegisterWidth: {
  [key in OperationSize]: SubRegisterWidth;
} = {
...
export const registerFamilyWidthMapping: {
  [key in RegisterFamily]: RegisterWidthMap;
} = {
...
export const register64WidthMapping: {
  [key in RegisterFamily]: RegisterWidthMap;
} = {
  [Register64.RAX]: raxWidthMap,
  [Register64.RBX]: rbxWidthMap,
  [Register64.RCX]: rcxWidthMap,
  [Register64.RDX]: rdxWidthMap,
  [Register64.RSP]: rspWidthMap,
  [Register64.RBP]: rbpWidthMap,
  [Register64.RDI]: rdiWidthMap,
  [Register64.RSI]: rsiWidthMap,
  [Register64.R8]: r8WidthMap,
  [Register64.R9]: r9WidthMap,
  [Register64.R10]: r10WidthMap,
  [Register64.R11]: r11WidthMap,
  [Register64.R12]: r12WidthMap,
  [Register64.R13]: r13WidthMap,
  [Register64.R14]: r14WidthMap,
  [Register64.R15]: r15WidthMap,
};

export type ModRmRegRegisterWidthMap = {
  [modRmReg in ModRMReg]: RegisterWidthMap;
};
...
export function canAddressHighByte(modrmreg: ModRMReg): boolean {
  return (
    modrmreg === ModRMReg.BH_rDI_MMX7_XMM7_YMM7 ||
...
export const modRMrmMobNot11bToRegisterMap: {
  [key in ModRMrmMobNot11b]?: RegisterFamily;
} = {
...
export const subRegisterWidthToWidth: {
  [key in SubRegisterWidth]: OperationSize;
} = {
...
export const opCodeToModRmRegRegisterMap8: {
  [type in RegisterType]: ModRmRegRegisterWidthMap;
} = {
...
export const opCodeToModRmRegRegisterMap: {
  [type in RegisterType]: ModRmRegRegisterWidthMap;
} = {
  [RegisterType.integer]: {
    [ModRMReg.rax_MMX0_XMM0_YMM0]: raxWidthMap,
