...
function parseAndAssert(
  ...
  const parser = new InstructionParser(dataView, 0, 0);
...
test('parse MOV', () => {
  ...
  parseAndAssertMOV('48 b8 c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('48 bb c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('48 b9 c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('48 ba c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('48 be c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('48 bf c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('48 bd c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('48 bc c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('49 b8 c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('49 b9 c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('49 ba c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('49 bb c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('49 bc c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('49 bd c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('49 be c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('49 bf c7 11 62 b3 02 01 00 00', [
  ...
  parseAndAssertMOV('b8 01 00 00 00', [
  ...
  parseAndAssertMOV('bb 01 00 00 00', [
  ...
  parseAndAssertMOV('b9 01 00 00 00', [
  ...
  parseAndAssertMOV('ba 01 00 00 00', [
  ...
  parseAndAssertMOV('be 01 00 00 00', [
  ...
  parseAndAssertMOV('bf 01 00 00 00', [
  ...
  parseAndAssertMOV('bd 01 00 00 00', [
  ...
  parseAndAssertMOV('bc 01 00 00 00', [
  ...
  parseAndAssertMOV('41 b8 01 00 00 00', [
  ...
  parseAndAssertMOV('41 b9 01 00 00 00', [
  ...
  parseAndAssertMOV('41 ba 01 00 00 00', [
  ...
  parseAndAssertMOV('41 bb 01 00 00 00', [
  ...
  parseAndAssertMOV('41 bc 01 00 00 00', [
  ...
  parseAndAssertMOV('41 bd 01 00 00 00', [
  ...
  parseAndAssertMOV('41 be 01 00 00 00', [
  ...
  parseAndAssertMOV('41 bf 01 00 00 00', [
  ...
  parseAndAssertMOV('66 41 b8 04 00', [
  ...
  parseAndAssertMOV('66 41 b9 04 00', [
  ...
  parseAndAssertMOV('66 41 bf 04 00', [
  ...
  parseAndAssertMOV('48 89 c0', [
    {register: Register.RAX},
    {register: Register.RAX},
  ]);
  parseAndAssertMOV('48 89 dc', [
    {register: Register.RSP},
    {register: Register.RBX},
  ]);
  parseAndAssertMOV('49 89 c8', [
    {register: Register.R8},
    {register: Register.RCX},
  ]);
  parseAndAssertMOV('49 89 d7', [
    {register: Register.R15},
    {register: Register.RDX},
  ]);
  parseAndAssertMOV('48 89 c3', [
    {register: Register.RBX},
    {register: Register.RAX},
  ]);
  parseAndAssertMOV('48 89 e1', [
    {register: Register.RCX},
    {register: Register.RSP},
  ]);
  parseAndAssertMOV('4c 89 c2', [
    {register: Register.RDX},
    {register: Register.R8},
  ]);
  parseAndAssertMOV('4c 89 fe', [
    {register: Register.RSI},
    {register: Register.R15},
  ]);

  // MOV dword register to register
  parseAndAssertMOV('89 c0', [
    {register: Register.EAX},
    {register: Register.EAX},
  ]);
  parseAndAssertMOV('89 dc', [
    {register: Register.ESP},
    {register: Register.EBX},
  ]);
  parseAndAssertMOV('41 89 c8', [
    {register: Register.R8D},
    {register: Register.ECX},
  ]);
  parseAndAssertMOV('41 89 d7', [
    {register: Register.R15D},
    {register: Register.EDX},
  ]);
  parseAndAssertMOV('89 c3', [
    {register: Register.EBX},
    {register: Register.EAX},
  ]);
  parseAndAssertMOV('89 e1', [
    {register: Register.ECX},
    {register: Register.ESP},
  ]);
  parseAndAssertMOV('44 89 c2', [
    {register: Register.EDX},
    {register: Register.R8D},
  ]);
  parseAndAssertMOV('44 89 fe', [
    {register: Register.ESI},
    {register: Register.R15D},
  ]);

  // MOV word register to register
  parseAndAssertMOV('66 89 c0', [
    {register: Register.AX},
    {register: Register.AX},
  ]);
  parseAndAssertMOV('66 89 dc', [
    {register: Register.SP},
    {register: Register.BX},
  ]);
  parseAndAssertMOV('66 41 89 c8', [
    {register: Register.R8W},
    {register: Register.CX},
  ]);
  parseAndAssertMOV('66 41 89 d7', [
    {register: Register.R15W},
    {register: Register.DX},
  ]);
  parseAndAssertMOV('66 89 c3', [
    {register: Register.BX},
    {register: Register.AX},
  ]);
  parseAndAssertMOV('66 89 e1', [
    {register: Register.CX},
    {register: Register.SP},
  ]);
  parseAndAssertMOV('66 44 89 c2', [
    {register: Register.DX},
    {register: Register.R8W},
  ]);
  parseAndAssertMOV('66 44 89 fe', [
    {register: Register.SI},
    {register: Register.R15W},
  ]);

  // MOV byte register to register
  parseAndAssertMOV('88 e4', [
    {register: Register.AH},
    {register: Register.AH},
  ]);
  parseAndAssertMOV('88 f8', [
    {register: Register.AL},
    {register: Register.BH},
  ]);
  parseAndAssertMOV('40 88 dc', [
    {register: Register.SPL},
    {register: Register.BL},
  ]);
  parseAndAssertMOV('41 88 c0', [
    {register: Register.R8B},
    {register: Register.AL},
  ]);
  parseAndAssertMOV('88 e9', [
    {register: Register.CL},
    {register: Register.CH},
  ]);
  parseAndAssertMOV('88 cf', [
    {register: Register.BH},
    {register: Register.CL},
  ]);
  parseAndAssertMOV('88 f3', [
    {register: Register.BL},
    {register: Register.DH},
  ]);
  parseAndAssertMOV('88 d5', [
    {register: Register.CH},
    {register: Register.DL},
  ]);
  parseAndAssertMOV('44 88 c1', [
    {register: Register.CL},
    {register: Register.R8B},
  ]);
  parseAndAssertMOV('88 e6', [
    {register: Register.DH},
    {register: Register.AH},
  ]);
  parseAndAssertMOV('40 88 e2', [
    {register: Register.DL},
    {register: Register.SPL},
  ]);
  parseAndAssertMOV('41 88 e8', [
    {register: Register.R8B},
    {register: Register.BPL},
  ]);
  parseAndAssertMOV('41 88 f7', [
...
test('parse XOR', () => {
  ...
  parseAndAssert(
    '45 30 c8',
    [{register: Register.R8B}, {register: Register.R9B}],
    InstructionType.XOR
  );
  ...
  parseAndAssert(
    '66 45 31 da',
    [{register: Register.R10W}, {register: Register.R11W}],
    InstructionType.XOR
  );
  ...
  parseAndAssert(
    '45 31 ec',
    [{register: Register.R12D}, {register: Register.R13D}],
    InstructionType.XOR
  );
  ...
  parseAndAssert(
    '4d 31 fe',
    [{register: Register.R14}, {register: Register.R15}],
    InstructionType.XOR
  );
...
test('parse ADD', () => {
  ...
  parseAndAssert(
    '44 00 c0',
    [{register: Register.AL}, {register: Register.R8B}],
    InstructionType.ADD
  );
  ...
  parseAndAssert(
    '66 44 01 d3',
    [{register: Register.BX}, {register: Register.R10W}],
    InstructionType.ADD
  );
  ...
  parseAndAssert(
    '44 01 de',
    [{register: Register.ESI}, {register: Register.R11D}],
    InstructionType.ADD
  );
  ...
  parseAndAssert(
    '48 01 c7',
    [{register: Register.RDI}, {register: Register.RAX}],
    InstructionType.ADD
  );
...
test('parse IMUL', () => {
  ...
  parseAndAssert(
    '66 41 0f af f0',
    [{register: Register.SI}, {register: Register.R8W}],
  ...
  parseAndAssert(
    '41 0f af f0',
    [{register: Register.ESI}, {register: Register.R8D}],
    InstructionType.IMUL
  );
  ...
  parseAndAssert(
    '49 0f af f0',
    [{register: Register.RSI}, {register: Register.R8}],
    InstructionType.IMUL
  );
...
test('MOVZX', () => {
  ...
  parseAndAssert(
    '66 41 0f b6 c0',
    [{register: Register.AX}, {register: Register.R8B}],
    InstructionType.MOVZX
  );
  ...
  parseAndAssert(
    '41 0f b6 c0',
    [{register: Register.EAX}, {register: Register.R8B}],
    InstructionType.MOVZX
  );
  ...
  parseAndAssert(
    '49 0f b6 c0',
    [{register: Register.RAX}, {register: Register.R8B}],
    InstructionType.MOVZX
  );
  ...
  parseAndAssert(
    '41 0f b7 c0',
    [{register: Register.EAX}, {register: Register.R8W}],
    InstructionType.MOVZX
  );
  ...
  parseAndAssert(
    '49 0f b7 c0',
    [{register: Register.RAX}, {register: Register.R8W}],
    InstructionType.MOVZX
  );
});
