...
import {Cpu} from "./Cpu";
import {ProcessEvent, ProcessEventListener, ProcessExitEvent} from "./ProcessEventListener";
...
export class Process {
    ...
    run(args: string[], processEventsListener: ProcessEventListener): void {
        const insideProcessEventsListener: ProcessEventListener = (event: ProcessEvent) => {
